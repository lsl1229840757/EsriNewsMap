	...
	<div class="container">
		<form action="../esri/changeinfo.action" method="post" name="changeForm" class="col-xs-6" id="changeform">
				...
				<div class="form-group has-feedback">
					...
					<input type="text" value="${sessionScope.user.name }" class="form-control" name="user.name" id="name" placeholder="昵称"/>
					<div class="error_sty">
				...
				<div class="form-group has-feedback">
					...
					<input type="text" value="${sessionScope.user.age }" class="form-control" name="age" id="age" placeholder="年龄" maxlength="3"/>
					<div class="error_sty">
				...
				<div class="form-group has-feedback">
					...
					<input type="text" class="form-control" name="checkCode" id="checkCode" maxlength="4" placeholder="验证码 ">
				...
				<div class="form-group has-feedback">
					...
					<a href="../user/userInformation.jsp" class="btn btn-primary btn-lg active btn-sm glyphicon glyphicon-link" role="button">返回信息界面</a>
				</div>
		</form>
	</div>
