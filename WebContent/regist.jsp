		...
		<div class="row">
			<div class="register span6">
				<form action="pict/regist.action" method="post">
					<h2>
						JOIN WITH <span class="red"><strong>US</strong></span>
					</h2>
					...
					<div class="form-group has-feedback">
						<label class="nickLabel">昵称</label> <input type="text"
							class="form-control" name="user.name" id="name" placeholder="昵称" />
						<div class="error_sty">
					...
					<div class="form-group has-feedback">
						<label class="pwdLabel">密码</label> <input type="password"
							class="form-control" name="password" id="pwd" placeholder="密码" />
						<div class="error_sty">
					...
					<div class="form-group has-feedback">
						<label class="pwdsureLabel">确认密码</label> <input type="password"
					...
					<div class="form-group has-feedback">
						<label class="checkLabel">验证码</label> <input type="text"
							class="form-control" name="checkCode" id="checkCode"
